...
// Helper function to edit a contact's information
static void editarContatoInfo(Contato *agenda, int *quantidade, int indice)
{
...
void menuEditarPorNome(Contato *agenda, int *quantidade)
{
    ...
    for (int i = 0; i < *quantidade; i++)
    {
        ...
        {
            encontrado = true;
            editarContatoInfo(agenda, quantidade, i);
            return;
        }
    }
