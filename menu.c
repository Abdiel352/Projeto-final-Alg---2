...
static void cadastrarTelefoneParaContato(Contato *agenda, int quantidade, int indiceContato)
{
    char novoTelefone[12];
    printf("Digite o telefone: ");
    scanf("%11s", novoTelefone);
    ...
    adicionarTelefone(&agenda[indiceContato], novoTelefone);
...
void menuCadastrarTelefonePorNome(Contato *agenda, int *quantidade)
{
    ...
    for (int i = 0; i < *quantidade; i++)
    {
        ...
        {
            cadastrarTelefoneParaContato(agenda, *quantidade, i);
            return;
        }
    }
